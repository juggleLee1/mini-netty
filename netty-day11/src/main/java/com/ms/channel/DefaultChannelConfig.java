...
import static com.ms.util.internal.ObjectUtil.checkPositive;
import static com.ms.util.internal.ObjectUtil.checkPositiveOrZero;

/**
 * @Author: PP-jessica
 * @Description:该类是NioSocketChannelConfig和NioServerSocketChannelConfig的公共父类，这里面有一些方法没做实现，之后讲到了会实现
...
public class DefaultChannelConfig implements ChannelConfig{
    ...
    public Map<ChannelOption<?>, Object> getOptions() {
        return getOptions(null, ChannelOption.CONNECT_TIMEOUT_MILLIS, ChannelOption.WRITE_SPIN_COUNT,
                ChannelOption.AUTO_READ, ChannelOption.AUTO_CLOSE, ChannelOption.SINGLE_EVENTEXECUTOR_PER_GROUP);
    }
