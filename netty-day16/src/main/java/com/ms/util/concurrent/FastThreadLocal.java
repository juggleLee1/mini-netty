...
import com.ms.util.internal.InternalThreadLocalMap;
...
public class FastThreadLocal<V> {
    ...
    //但这个属性为静态变量。会最先被赋值，这个时候得到的值是0。只会被创建一次，并且不会改变
    private static final int variablesToRemoveIndex = InternalThreadLocalMap.nextVariableIndex();

    /**
     * @Author: PP-jessica
     * @Description:还记得FastThreadLocalRunnable这个类吗？removeAll方法就会在该类的run方法中被调用
     */
    ...
    /**
     * @Author: PP-jessica
     * @Description:得到threadlocalmap数组存储的元素个数
     */
    ...
    /**
     * @Author: PP-jessica
     * @Description:该方法是把该线程引用的fastthreadlocal组成一个set集合，然后方到threadlocalmap数组的0号位置
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * @Author: PP-jessica
     * @Description:删除set集合中的某一个fastthreadlocal对象
     */
    ...
    /**
     * @Author: PP-jessica
     * @Description:FastThreadLocal构造器，创建的那一刻，threadlocal在map中的下标就已经确定了
     */
    ...
    /**
     * @Author: PP-jessica
     * @Description:得到fastthreadlocal存储在map数组中的数据
     */
    @SuppressWarnings("unchecked")
    public final V get() {
        //得到存储数据的map
    ...
    /**
     * @Author: PP-jessica
     * @Description:得到fastthreadlocal存储在map数组中的数据，只不过这里把map当作参数纯进来了
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * @Author: PP-jessica
     * @Description:这是个初始化的方法，但并不是对于threadLocalMap初始化，这个方法的意思是，如果我们还没有数据存储在threadlocalmap
    ...
    /**
     * @Author: PP-jessica
     * @Description:把要存储的value设置到threadlocalmap中
     */
    ...
    /**
     * @Author: PP-jessica
     * @Description:删除InternalThreadLocalMap中的数据
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * @Author: PP-jessica
     * @Description:该方法可以由用户自行定义扩展，在删除本地map中的数据时，可以扩展一些功能
     */
