...
public abstract class ChannelInitializer<C extends Channel> extends ChannelInboundHandlerAdapter {
    ...
    /**
     * @Author: PP-jessica
     * @Description:这个set集合是为了防止已经添加了该handler的ChannelPipeline再次被初始化，主要用于
    ...
    /**
     * @Author: PP-jessica
     * @Description:该方法会调用initChannel方法，而initChannel方法是个抽象方法，由用户自己在实现类中实现
     * 而实现通常是向ChannelPipeline中添加handler，在测试中我会给出具体例子
     */
    @Override
