...
import com.ms.util.internal.DefaultPriorityQueue;
import com.ms.util.internal.PriorityQueueNode;
...
final class ScheduledFutureTask<V> extends PromiseTask<V> implements ScheduledFuture<V>, PriorityQueueNode {
    ...
    static long deadlineNanos(long delay) {
        ...
        //开始执行了
        //如果我的定时任务是在第1秒执行的，现在是3秒，那就是3-1+2等于5，也就是说用户提交的定时任务要在距离开始时间过去了5秒的时候执行
   ...
   //这个就是该任务要被执行的时间差
    ...
    /**
     * @Author:PP-jessica
     * @Description:获取要过多久才能执行这个定时任务的时间
     */
    ...
    /**
     * @Author:PP-jessica
     * @Description:比较器的具体使用逻辑，就是比较两个定时任务执行时间的大小，谁的时间小，谁就排在任务队列的前面
     */
    @Override
    ...
    /**
     * @Author: PP-jessica
     * @Description:下面这两个方法会在DefaultPriorityQueue类中被调用
     */
    @Override
