...
public class ServerBootstrap extends AbstractBootstrap<ServerBootstrap, Channel> {
    ...
    /**
     * @Author: PP-jessica
     * @Description:在服务端设定的客户端的handler
     */
    ...
    /**
     * @Author: PP-jessica
     * @Description:该方法据上节课又有了改动，这次跟源码一样了
     */
    @Override
    ...
    /**
     * @Author: PP-jessica
     * @Description:该内部类也是一个handler，是handler就该看看它的需要被回调的方法是怎么实现的
     */
    private static class ServerBootstrapAcceptor extends ChannelInboundHandlerAdapter {

        /**
         * @Author: PP-jessica
         * @Description:下面这四个属性，分别都和客户端channel有关，也就是NioSocketChannel，
         * childHandler()
         * childOption().
         * childAttribute("")
         * childAttr()
        ...
        /**
         * @Author: PP-jessica
         * @Description:当该方法被回调的时候，说明是有读事件进来了，而且该类只关注客户端channel连接和初始化。客户端channel连接进来
         * 也会调用read方法，可以去NioEventLoop类中产看调用逻辑
         */
        @Override
        @SuppressWarnings("unchecked")
