...
import static com.ms.util.internal.StringUtil.simpleClassName;
...
public class HashedWheelTimer implements Timer {
    ...
    /**
     * @Author: PP-jessica
     * @Description:这个是真正被调用的构造器，threadFactory是创建线程的工厂，tickDuration是tick的时长，也就是指针多久转一格，
...
//            }
    ...
    /**
     * @Author: PP-jessica
     * @Description:时间轮的工作线程，也就是执行定时任务的线程在创建第一个定时任务的时候被启动了，并且只启动一次
     * 当调用该方法的时候，时间轮的work线程就启动了
     */
    @Override
    ...
    private final class Worker implements Runnable {
        ...
        /**
         * @Author: PP-jessica
         * @Description:这个属性代表当前时间轮的指针移动了几个刻度
         */
        private long tick;
        ...
        /**
         * @Author: PP-jessica
         * @Description:该方法就是要把任务队列中的定时任务转移到时间轮的数组当中
         */
    ...
    /**
     * @Author: PP-jessica
     * @Description:封装了用户提交的定时任务，而且该类的对象构成了bucket的双向链表
     */
    private static final class HashedWheelTimeout implements Timeout {

        /**
         * @Author: PP-jessica
         * @Description:下面三个是该Timeout的状态，字面意思直接翻译即可
         */
        ...
        /**
         * @Author: PP-jessica
         * @Description:删除定时任务的方法，这里其实是找到该定时任务所在的bucket，然后在bucket的双向链表中删除
         */
        void remove() {
    ...
    private static final class HashedWheelBucket {
        ...
        /**
         * @Author: PP-jessica
         * @Description:在这个方法中，timeout中的bucket属性被赋值了
         */
        ...
        /**
         * @Author: PP-jessica
         * @Description:执行定时任务的方法，传进来的参数是到期的时间
         */
