...
import com.ms.util.Attribute;
import com.ms.util.AttributeKey;
import com.ms.util.ResourceLeakHint;
...
//    }
    ...
    public ChannelHandlerContext fireChannelUnregistered() {
        invokeChannelUnregistered(findContextInbound(ChannelHandlerMask.MASK_CHANNEL_UNREGISTERED));
        return this;
    }
...
//        }
    ...
    public ChannelFuture bind(final SocketAddress localAddress, final ChannelPromise promise) {
        ...
        final AbstractChannelHandlerContext next = findContextOutbound(ChannelHandlerMask.MASK_BIND);
        EventExecutor executor = next.executor();
        if (executor.inEventLoop(Thread.currentThread())) {
